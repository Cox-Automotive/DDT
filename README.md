...
CF DDT is a tool developed to bring ManageIQ (https://github.com/ManageIQ/manageiq) / Redhat Cloudforms into a true agile, CI/CD environment. The tool helps address the common challenges and pitfalls when customizing ManageIQ/Cloudforms in an agile environment while leveraging a CI/CD strategy. 
